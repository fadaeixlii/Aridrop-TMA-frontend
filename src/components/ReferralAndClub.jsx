...
export default function ReferralAndClub({ setActiveTab }) {
  return (
    <div className="flex items-center gap-4">
      <div
        className="rounded-2xl bg-[#2E2E2E] border border-[#3D3D3D] w-1/2 aspect-square flex flex-col items-center justify-between p-4 gap-2 text-white text-lg"
        onClick={() => {
          setActiveTab("Referral");
        }}
      >
        <span className="bg-[#363636] p-2 rounded-full flex items-center justify-center">
          <img src={hornImage} alt="" className="size-20" />
        </span>
        Referral
      </div>
      <div
      ...
      >
        <span className="bg-[#363636] p-2 rounded-full flex items-center justify-center">
          <img src={earthImage} alt="" className="size-20" />
        </span>
        Club
      </div>
    </div>
